(function($){
		  $.extend({progressBar:new function()
										{this.defaults={
											...
											barImage:{0:'images/progressbg_red.gif',30:'images/progressbg_orange.gif',70:'images/progressbg_green.gif'},
											running_value:0,
											value:0,
											image:null};
										this.construct=function(arg1,arg2){
											var argvalue=null;
											var argconfig=null;
											if(arg1!=null){if(!isNaN(arg1)){argvalue=arg1;if(arg2!=null){argconfig=arg2;}}else{argconfig=arg1;}}
											return this.each(function(child){
																	...
																	if(argvalue!=null&&this.bar!=null&&this.config!=null){
																		...
																		config.id=$this.attr('id')?$this.attr('id'):Math.ceil(Math.random()*100000);if(argvalue==null)
																		argvalue=$this.html().replace("%","")
																		config.value=argvalue;config.running_value=0;
													...
													function getBarImage(config){
														...
														if(typeof(config.barImage)=='object'){
															for(var i in config.barImage){
																if(config.running_value>=parseInt(i)){image=config.barImage[i];}else{break;}
															}
														}
														return image;
													}
													function getText(config){
														if(config.showText){
															if(config.textFormat=='percentage'){return" "+Math.round(config.running_value)+"%";}
															else if(config.textFormat=='fraction'){return" "+config.running_value+'/'+config.max;}
														}
													}
													...
													var t=setInterval(function(){
																			...
																			if(config.running_value>config.value){
																				...
																				}else{config.running_value-=config.increment;}
